...
export default function TopNav() {
  ...
  const { theme, changeSidebarVisibility } = useAppContext()

  return (
    <nav className="main_layout_navbar navbar justify-start gap-4">
      <a className="sidebar-toggle items-center">
        {theme === 'light' ? <svg onClick={() => changeSidebarVisibility()} className="cursor-pointer ms-2 my-2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0,0,256,256">
          ...
          <svg onClick={() => changeSidebarVisibility()} className="cursor-pointer ms-2 my-2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0,0,256,256">
